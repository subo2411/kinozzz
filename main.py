...
category_list = {'films': 'Фильмы', 'serials' : 'Сериалы','series' : 'Сериалы', 'cartoons':'Мультфильмы', 'cartoon':'Мультфильмы', 'cartoon-serials' : 'Мультсериалы', 'cartoon-series': 'Мультсериалы', 'film': 'Фильмы'}
last_domain = ''
...
async def send_welcome(message: types.Message, state: FSMContext):
    ...
    text = f'🎞️<b><u>Kinozzz</u></b> — уникальный в своём роде бот, который даст Вам возможность <b>бесплатно</b> наслаждаться новинками <b>Российского</b> и <b>зарубежного</b> кинематографа с <u>любого устройства</u>.\n\n'
...
async def popular_menu(call: types.CallbackQuery):
    await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text= '🚀 Вы перешли в раздел <b>«Популярное»</b>, здесь находятся видеоматериалы, которые <b>популярны</b> на текущий год.\n\n<i>👉 Выберите <b>категорию</b>, в которой желаете выбрать <b>видеоматериал</b> для просмотра.</i>', reply_markup=popular_menu_kb)

# Новинки (Фильмы)
@dp.callback_query_handler(text="news_menu", state="*")
async def news_menu(call: types.CallbackQuery):
    await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text= '🆕 Вы перешли в раздел <b>«Новинки»</b>, здесь находятся <b>новые</b> видеоматериалы, которые были <b>добавлены</b> в течении последних суток.\n\n<i>👉 Выберите <b>категорию</b>, в которой желаете выбрать <b>видеоматериал</b> для просмотра.</i>', reply_markup=news_menu_kb)
...
async def send(call: types.CallbackQuery):
    await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text= '🔍 Вы перешли в раздел <b>«Поиск»</b>, пожалуйста, выберите <b>тип поиска</b>, которым желаете воспользоваться.', reply_markup=search)

@dp.callback_query_handler(text="categories", state="*")
async def send(call: types.CallbackQuery):
    await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text= '🔍Вы перешли в раздел <b>«Поиск по названию»</b>, пожалуйста, выберите <b>категорию</b>, в которой желаете найти <b>видеоматериал</b>.', reply_markup=category)
...
async def send(call: types.CallbackQuery):
    ...
    await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text= '🎞️Вы перешли в раздел <b>«Подборки»</b>, пожалуйста, выберите <b>подборку</b>, в которой желаете выбрать <b>видеоматериал</b> для просмотра.', reply_markup=kb)
...
async def send(call: types.CallbackQuery):
  await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text= '🎞️<b><u>Kinozzz</u></b> — <b>первый онлайн-кинотеатр</b> в Telegram, который предоставляет возможность <b><u>бесплатно</u></b> наслаждаться новинками <b>Российского</b> и <b>зарубежного</b> кинематографа.\n\n💡 <b>Основные возможности бота:</b>\n— Удобный поиск фильмов, сериалов, мультфильмов и т.п. по названию;\n— <b>Подборки</b> видеоматериалов;\n— Функция <b>«Мои закладки»</b>, чтобы любимые фильмы и сериалы были всегда рядом;\n— Удобный плеер;\n— Высокое качество каждого видеоматериала;\n— Ежедневное пополнение новинками кино.', reply_markup=about)

@dp.callback_query_handler(text="contacts", state="*")
async def send(call: types.CallbackQuery):
  await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text= '<b>🔥Мы всегда рады новым идеям и предложениям, которые будут полезны для нашей площадки!</b>\n\n📌<i>В случае возникновения жалоб на авторские права, обращайтесь на e-mail: <b>yusufbekovb@gmail.com</b> \n\n По рекламе: @yusufbekovv24</i>', reply_markup=contacts)
...
async def send(call: types.CallbackQuery):
    await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text= '🆔 Пожалуйста, введите и отправьте <b>ID видеоматериала</b> для поиска.\n\n❗<i><b>Важно:</b> указывайте корректный ID, да бы избежать неверную выдачу видеоматериала.</i>', reply_markup=go_poisk)
    ...
    async def handle_text(message: types.Message, state: FSMContext):
     ...
     play.add(types.InlineKeyboardButton(text="😍 Смотреть онлайн", url=f'https://bot.kinozzz.monster/play/?id={film_id}'))
...
async def send(call: types.CallbackQuery):
    await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text= '🔎 Укажите оригинальное название <b>фильма</b> для поиска.\n\n❗<i><b>Важно:</b> указывайте точное название для корректного поиска.</i>', reply_markup=inlinekeyboard2)
...
async def send(call: types.CallbackQuery):
    ...
    async def handle_text(message: types.Message, state: FSMContext):
            ...
            try:
                ...
                await message.answer('😔Не удалось найти <b>аниме-фильм</b> с подобным названием.\n\n❗<i>Введите корректное название для более точного поиска.</i>', reply_markup=inlinekeyboard4)
                await state.finish()

@dp.callback_query_handler(text="cartoon_serials", state="*")
async def send(call: types.CallbackQuery):
    await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text= '🔎 Укажите оригинальное название <b>аниме-сериала</b> для поиска.\n\n❗<i><b>Важно:</b> указывайте точное название для корректного поиска.</i>', reply_markup=inlinekeyboard5)
    ...
    async def handle_text(message: types.Message, state: FSMContext):
            ...
            try:
                ...
                print(ex)
                await message.answer('😔 Не удалось найти <b>мультсериал</b> с подобным названием.\n\n❗<i>Введите корректное название для более точного поиска.</i>', reply_markup=inlinekeyboard5)
                await state.finish()

@dp.callback_query_handler(text="cartoon", state="*")
async def send(call: types.CallbackQuery):
    await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text= '🔎 Укажите оригинальное название <b>мультфильма</b> для поиска.\n\n❗<i><b>Важно:</b> указывайте точное название для корректного поиска.</i>', reply_markup=inlinekeyboard6)
...
async def send(call: types.CallbackQuery):
    ...
    async def handle_text(message: types.Message, state: FSMContext):
            ...
            try:
                ...
                await message.answer('😔 Не удалось найти <b>аниме-сериал</b> с подобным названием.\n\n❗<i>Введите корректное название для более точного поиска.</i>', reply_markup=inlinekeyboard7)
                await state.finish()

@dp.callback_query_handler(text="tv", state="*")
async def send(call: types.CallbackQuery):
    await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text= '🔎Укажите оригинальное название <b>ТВ-шоу</b> для поиска.\n\n❗<i><b>Важно:</b> указывайте точное название для корректного поиска.</i>', reply_markup=inlinekeyboard8)
...
async def back(call: types.CallbackQuery, state: FSMContext):
    await state.finish()
    await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text= '🏠 Вы вернулись в <b>главное меню</b>.\n\n🎦 Здесь вы можете выбрать <b>раздел</b>, в котором желаете найти или выбрать видеоматериал для просмотра.', reply_markup=inlinekeyboard, inline_message_id=call.inline_message_id)
